...
def prepare_data(args, mode):
    if mode == "train":
        data_dir = os.path.join(os.getcwd(), mode, args.train_subdir)
        data = glob.glob(os.path.join(data_dir, "*"))

    elif mode == "test":
        data_dir = os.path.join(os.getcwd(), mode, args.test_subdir)
        data = glob.glob(os.path.join(data_dir, "*"))
        print(data_dir)

    elif mode == "inference":
        data_dir = os.path.join(os.getcwd(), mode, args.infer_subdir)
